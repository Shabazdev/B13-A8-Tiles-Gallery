/**
 * RegisterView — Firebase Authentication
 * Handles email/password registration and Google OAuth popup.
...
export default function RegisterView({ onNavigate, onRegisterSuccess, onGoogleSuccess }: RegisterViewProps) {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      // Google signup also logs the user in → go straight to home
