        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs">
              <li><Link href="/all-tiles" className="hover:text-white transition-colors">Italian Carrara Marble</Link></li>
              <li><Link href="/all-tiles" className="hover:text-white transition-colors">Moroccan Zellige Clay</Link></li>
              <li><Link href="/all-tiles" className="hover:text-white transition-colors">Crystalline Glass Brick</Link></li>
              <li><Link href="/all-tiles" className="hover:text-white transition-colors">Hexagonal Modern Mosaics</Link></li>
            </ul>
          </div>
